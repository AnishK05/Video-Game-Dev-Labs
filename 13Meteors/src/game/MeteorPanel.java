...
public class MeteorPanel extends JPanel implements ActionListener {
	...
	public MeteorPanel()
	{
		...
		try 
		{
			BG = ImageIO.read(new File("C:/Users/anish/Documents/VS Code -- Documents/Java/13Meteors/src/images/starfield.png"));
		}
		catch(Exception e) 
		{ 
			e.printStackTrace();
		...
		score = new Score();
		laserSound = new Sound("C:/Users/anish/Documents/VS Code -- Documents/Java/13Meteors/src/sounds/Laser_Shoot.wav");
		explode = new Sound("C:/Users/anish/Documents/VS Code -- Documents/Java/13Meteors/src/sounds/rumble1.wav");
		alarm = new Sound("C:/Users/anish/Documents/VS Code -- Documents/Java/13Meteors/src/sounds/alarm.wav");
